...
Item {
    ...
    property bool landscapePlaybackControls: window.width >= 668
    ...
    CustomButton {
        id: fullScreenButton
        icon.source: window.fullScreen ? "../images/zoom_minimize.svg"
                                     : "../images/zoom_maximize.svg"
        onClicked: {
            window.fullScreen ?  window.showNormal() : window.showFullScreen()
